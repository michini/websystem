...
@section('contenido')
    ...
    <div class="row">
            ...
            <div class="well">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input name="lugar" type="text" class="form-control" id="lugar" value="{{$ultimo->lugar}}" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class='input-group date col-lg-5' id='datetimepicker4' style="padding-left: 14px;">
                            <input name="fecha" type='text' class="form-control" value="{{$ultimo->fecha}}" disabled/>
                    ...
                    <div class="form-group">
                        ...
                        <div class='input-group date col-lg-5' id='datetimepicker3' style="padding-left: 14px;">
                            <input name="hora" type='text' class="form-control" value="{{$ultimo->hora}}" disabled/>
                        <span class="input-group-addon">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control" id="descripcion" name="descripcion" disabled>{{$ultimo->descripcion}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <select name="paquete" id="paquete" class="form-control" disabled>
                                <option>{{$ultimo->paquete->tipo}}</option>
                            </select>
                        </div>
                        <label for="" class="col-lg-2 control-label">Precio:</label>
                        <div class="col-lg-3">
                            <input type="text" value="{{$ultimo->paquete->precio}}" id="monto_paquete" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            <select name="compromiso" id="compromiso" class="form-control" disabled>
                                <option>{{$ultimo->compromiso->nombre}}</option>
                            </select>
                        </div>
                    </div>
                </form>
        ...
        <div class="col-lg-4">
            <div class="well">
                {!! Form::open(['route'=>['admin.contrato.store','id_evento'=>$ultimo->id],'method'=>'POST','role'=>'form','class'=>'form-horizontal']) !!}
                <div class="radio">
                    <label>
            ...
            <div class="well">
                ...
                {!! Form::open(['route'=>'admin.cliente.store','method'=>'POST','role'=>'form','class'=>'form-horizontal']) !!}
